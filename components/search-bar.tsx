  ...
  return (
    <form className="relative w-full max-w-2xl" role="search">
      ...
      <input
        ...
        className="h-12 w-full rounded-2xl border border-border/80 bg-card/70 pl-11 pr-16 text-sm shadow-sm outline-none transition placeholder:text-muted-foreground focus:border-primary focus:ring-2 focus:ring-primary/20"
